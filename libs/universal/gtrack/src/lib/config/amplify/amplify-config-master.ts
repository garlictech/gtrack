...
// Written by aws-amplify-serverless-plugin/1.4.1 on 2020-11-04T13:53:35.004Z
...
const awsmobile: IAWSAmplifyConfiguration = {
    ...
    aws_appsync_graphqlEndpoint: 'https://incqeivhczaypeqx2zjkrr4sk4.appsync-api.us-east-1.amazonaws.com/graphql',
    aws_appsync_region: 'us-east-1',
    aws_cloud_logic_custom: [
        {
            endpoint: 'https://wv3wkne78a.execute-api.us-east-1.amazonaws.com/master',
